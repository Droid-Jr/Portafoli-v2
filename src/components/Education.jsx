...
function Education() {
  return (
    <section className=" mt-36 md:mt-0 w-[90%]  m-auto justify-center md:h-[90%]  md:min-w-[70%]  flex flex-col ">
        <section className="  ">
        ...
        <article className={`grid gap-7  md:gap-10 md:grid-cols-2 `}>
            ...
            <div className="1 flex">
                ...
                <div className={`1-2 w-[87%] grid `}>
                    ...
                    <p className={`[font-size:_clamp(.9em,1vw,1.2em)]   font-fira text-[#ffffff] `}> from Academlo with socialization skills, planning strategies to achieve a good objective and leadership. I like to learn new things, to be able to achieve the proposed objectives, I am interested in developing in very advanced areas such as programming, web design, I am motivated by teamwork, progress and good appearance.</p>
                </div>
            </div>

            <div className={`2 flex`}>

            <div className={`1-1 w-[50px] flex flex-col items-center`}>
            ...
            <div className={`1-1 w-[50px] flex flex-col items-center`}>
                ...
                <div className={`1-2 w-[87%] grid gap-4`}>
                    <h2 className={`[font-size:_clamp(1.4em,3vw,1.8em)] font-medium font-fira text-[#C778DD]`}>Academlo</h2>
                    ...
                    <p className={`[font-size:_clamp(.85em,1vw,1.2em)]  font-fira text-[#ffffff]`}>In React We learned to create web applications with React JS, achieving great interaction with the user using previous knowledge of HTML, CSS and Javascript.</p>
                </div>
