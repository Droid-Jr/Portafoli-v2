        ...
        <article className={`grid gap-7  md:gap-10 md:grid-cols-2 ` } >
          <div className=" flex">
            ...
            <div className={` w-[87%] grid `} data-aos="fade-right">
              ...
              >
                {" "}
                from Academlo with socialization skills, planning strategies to
                achieve a good objective and leadership. I like to learn new
                things, to be able to achieve the proposed objectives, I am
                interested in developing in very advanced areas such as
                programming, web design, I am motivated by teamwork, progress
                and good appearance.
              </p>
            </div>
          </div>
          ...
          <div className={` flex`}>
            ...
            <div className={`w-[87%] grid `} data-aos="fade-right">
              ...
              <a
                ...
                target="_blank"
                className={`[font-size:_clamp(1.2em,2vw,1.2em)] font-medium font-fira text-[#ffffff]  border border-[#C778DD] w-[140px] text-center h-[35px] rounded-lg`}
              >
                Certificate
              </a>
              ...
              >
                In fundamentals we obtained the necessary skills to correctly
                develop the visual part of a responsive website without using
                libraries/frameworks, as well as add dynamic content with
                javascript, work collaboratively with git.
              </p>
            </div>
          </div>
          ...
          <div className={` flex`}>
            ...
            <div className={` w-[87%] grid gap-4`} data-aos="fade-right">
              ...
              <a
                ...
                target="_blank"
                className={`[font-size:_clamp(1.2em,2vw,1.2em)] border border-[#C778DD]  font-medium font-fira text-[#ffffff] w-[140px] text-center h-[35px] rounded-lg`}
              >
                Certificate
              </a>
              ...
              >
                In React We learned to create web applications with React JS,
                achieving great interaction with the user using previous
          ...
          <div className={` flex`}>
            ...
            <div className={` w-[87%] grid gap-4`} data-aos="fade-right"> 
              ...
              <a
                ...
                target="_blank"
                className={`[font-size:_clamp(1.2em,2vw,1.2em)] font-medium font-fira text-[#ffffff] w-[140px] text-center border border-[#C778DD] h-[35px] rounded-lg`}
              >
                Certificate
              </a>
              ...
              >
                In Back we learned how to build an application from the server
                with Node and Express from 0 to deployment on a server and make
                a Rest API using a relational database, user authentication,
                security against XSS and CSRF attacks, you will be able to
                validate the data you receive the server and can build custom
                middlewares with Express
              </p>
            </div>
          </div>
        </article>
